...
#res_t, res_time = test.run_it(locsumm,chemsumm,params,2,pp,timeseries)
...
plot = plt.plot(timeseries.time, res_time.loc[(slice(None),'EHDPP',0),'a1_t1'],\
   'r--', timeseries.time, res_time.loc[(slice(None),'EHDPP',2),'a1_t1'], 'b--',\
   timeseries.time, res_time.loc[(slice(None),'EHDPP',3),'a1_t1'], 'g--')
#Seaborn
